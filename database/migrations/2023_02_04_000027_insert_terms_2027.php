...
class InsertTerms2027 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::table('terms')->insert([
            [
                'state_id'   => $state_id, 
                'number'     => 1,
                'start_date' => new Carbon('27 January 2027'),
                'end_date'   => new Carbon('9 April 2027'),
            ],
            [
                'state_id'   => $state_id, 
                'number'     => 2,
                'start_date' => new Carbon('26 April 2027'),
                'end_date'   => new Carbon('2 July 2027'),
            ],
            [
                'state_id'   => $state_id, 
                'number'     => 3,
                'start_date' => new Carbon('19 July 2027'),
                'end_date'   => new Carbon('24 September 2027'),
            ],
            [
                'state_id'   => $state_id, 
                'number'     => 4,
                'start_date' => new Carbon('11 October 2027'),
                'end_date'   => new Carbon('10 December 2027'),
            ],
        ]);
